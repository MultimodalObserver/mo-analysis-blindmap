 ...
 * @author gustavo
 */
public class JFXPanelBlindMap extends JFXPanel {
    ...
    private BlindMap blindMap;
    private ObservableMap<String, Duration> markers;

    private float opacityMap;

    public JFXPanelBlindMap() throws FileNotFoundException {
    ...
    private void formComponentResized(java.awt.event.ComponentEvent evt) {
        //System.out.println("resizeando");
        //JOptionPane.showMessageDialog(null, "resizando");
        this.blindMap.resize(this.realWidth, this.realHeight);
    }
    ...
    public void paint(Graphics g) {
        ...
        g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
                this.opacityMap));
        g.drawImage(this.blindMap.getMap(), 0, 0, this);
        g2d.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
                1));
...
//        Scene scene =  new Scene(new Group(mediaView),this.getWidth(),this.getHeight());
        ...
        while (media.getWidth() == 0 || media.getHeight() == 0) {
            try {
                ...
                Logger.getLogger(JFXPanelBlindMap.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        this.blindMap = new BlindMap(this.originalWidth, this.originalHeight);
    ...
    public void addData(GazeData data) {
        ...
        if (data.state != GazeData.STATE_TRACKING_FAIL
            ...
            this.blindMap.addPoint(actualX, actualY);
    ...
    public void mapToFile(File outputFile) {
        ...
        g.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
                this.opacityMap));
        g.drawImage(this.blindMap.getMap(), 0, 0, null);
...
////////////////////////////////////////////////////////////////
    ...
    public void restarBlindMap() {
        this.blindMap.restart();
    }
    ...
    public void setBlindmapOpacity(float f) {
        this.opacityMap = f;
    }

    public void updateBlindMap() {
        this.blindMap.restart();
